...
class PythiaModel(BaseModel):
    def __init__(self):
        super().__init__()
        self.model_name = "pythia-1.4b"
        self.native_context_length = 2048
    
    def load(self, model_path: str = "EleutherAI/pythia-1.4b", **kwargs):
        """Load EleutherAI/pythia-1.4b model and tokenizer"""
        print(f"Loading EleutherAI/pythia-1.4b from {model_path}...")
