#!/usr/bin/env python3
"""
Fine-tune TinyLlama with YaRN Context Extension

Implementation following ICLR 2024 paper specifications:
"YaRN: Efficient Context Window Extension of Large Language Models"

Usage:
    python scripts/finetune_tinyllama_yarn.py \
        --data_path data/pile_train_stratified/train_documents.json \
        --output_dir checkpoints/tinyllama_yarn_8k \
        --context_length 8192

    python scripts/finetune_tinyllama_yarn.py \
        --data_path data/pile_train_stratified/train_documents.json \
        --output_dir checkpoints/tinyllama_yarn_32k \
...
def main():
    parser = argparse.ArgumentParser(
        description="Fine-tune TinyLlama with YaRN context extension"
    )
    ...
    parser.add_argument(
        "--output_dir", 
        default="checkpoints/tinyllama_yarn", 
    ...
    # Print configuration
    print("\n" + "="*80)
    print("YaRN Fine-tuning for TinyLlama")
    print("="*80)
